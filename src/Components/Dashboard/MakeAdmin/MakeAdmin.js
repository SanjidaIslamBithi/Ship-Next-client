        ...
        <div className='row'>
          <div className='col-md-6 mb-5'>
            <form onSubmit={handleAdminSubmit}>
              ...
              <button type='submit' className='btn custom-black-btn'>
                Make Admin
              </button>
            </form>
          </div>
          ...
          <div className='col-md-6'>
            ...
            <p>
              Input any existing user email address of this website to create a
              new admin. Only an admin can create a new admin.
            </p>
          </div>
        </div>
      </div>
