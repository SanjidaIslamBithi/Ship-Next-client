    ...
    <div className='container-fluid py-5 login-page'>
      <div className='row d-flex flex-column justify-content-center align-items-center'>
        <div className='col-md-6'>
          <form
            className='login-form bg-white pb-5 pt-3 px-5 rounded shadow'
          ...
          <div className='mt-3 mb-0 text-'>
            ...
            <div>
              <p className=' fw-fold '>
                ...
                <br />
                You can create your own personal account by clicking{' '}
                <span className='fw-bold'>Register</span> or Sign in with
                Google.
              </p>
            </div>
          </div>
